      ...
      <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/" className="text-white/80 hover:text-accent transition-colors text-sm">
                  Anasayfa
                </Link>
              </li>
              <li>
                <Link href="/urunler" className="text-white/80 hover:text-accent transition-colors text-sm">
                  Tüm Ürünler
                </Link>
              </li>
              <li>
                <Link href="/hakkimizda" className="text-white/80 hover:text-accent transition-colors text-sm">
                  Hakkımızda
                </Link>
              </li>
              <li>
                <Link href="/iletisim" className="text-white/80 hover:text-accent transition-colors text-sm">
                  İletişim
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-2">
                ...
                <span className="text-white/80">{siteConfig.address.full}</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-accent flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-white/80">{siteConfig.workingHours.display}</span>
              </div>
              <a
